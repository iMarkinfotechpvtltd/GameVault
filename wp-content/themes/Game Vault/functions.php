...
/* ------ custom post for FAQS -------*/

function FAQS_init() {
	$labels = array(
		'name'               => __( 'FAQS' ),
		'singular_name'      => __( 'All FAQS Post' ),
		'menu_name'          => __( 'FAQS Post'),
		'name_admin_bar'     => __( 'FAQS'),
		'add_new'            => __( 'Add New FAQ' ),
		'add_new_item'       => __( 'Add New FAQ' ),
		'new_item'           => __( 'New FAQ Post'),
		'edit_item'          => __( 'Edit FAQ Post'),
		'view_item'          => __( 'View FAQS post'),
		'all_items'          => __( 'All FAQS post'),
		'search_items'       => __( 'Search FAQS post'),
...
function Slider_init() {
	$labels = array(
		'name'               => __( 'Slider' ),
		'singular_name'      => __( 'All Slider Post' ),
		'menu_name'          => __( 'Slider Post'),
...
add_image_size( 'logo', 322, 167, true );
add_image_size( 'blog', 460, 280, true );
add_image_size( 'corporate-logo', 556, 369, true );
...
function Gallery_Images_init() {
	$labels = array(
		...
		'singular_name'      => __( 'All Gallery Images' ),
		'menu_name'          => __( 'Gallery Images'),
		'name_admin_bar'     => __( 'Gallery Images'),
		'add_new'            => __( 'Add New Images' ),
		'add_new_item'       => __( 'Add New Images' ),
		'new_item'           => __( 'New Gallery Images'),
		'edit_item'          => __( 'Edit Gallery Images'),
		'view_item'          => __( 'View Gallery Images'),
		'all_items'          => __( 'All Gallery Images'),
		'search_items'       => __( 'Search Gallery Images'),
		'parent_item_colon'  => __( 'Parent Gallery Images:'),
...
function Gallery_video_init() {
	$labels = array(
		'name'               => __( 'Gallery Viedo' ),
		'singular_name'      => __( 'All Gallery Viedo' ),
		'menu_name'          => __( 'Gallery Viedo'),
		'name_admin_bar'     => __( 'Gallery Viedo'),
		'add_new'            => __( 'Add New Viedo' ),
		'add_new_item'       => __( 'Add New Viedo' ),
		'new_item'           => __( 'New Gallery Viedo'),
		'edit_item'          => __( 'Edit Gallery Viedo'),
		'view_item'          => __( 'View Gallery Viedo'),
		'all_items'          => __( 'All Gallery Viedo'),
		'search_items'       => __( 'Search Gallery Viedo'),
		'parent_item_colon'  => __( 'Parent Gallery Viedo:'),
		'not_found'          => __( 'No Gallery Viedo found.'),
		'not_found_in_trash' => __( 'No Gallery Viedo found in Trash.')
	);
...
add_action( 'init', 'Gallery_video_init' );
...
echo '<style type="text/css">
  h1 a {
    background-image: url(' . get_template_directory_uri() . '/images/login_logo.png) !important;
